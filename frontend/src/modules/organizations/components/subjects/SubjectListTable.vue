...
interface Emits {
    (event: "select", item: SubjectListItemView): void;
    (
        event: "action",
        payload: {
...
function getDisabledActions(item: SubjectListItemView): OrganizationTableActionKey[] {
                ...
                <tbody class="org-table__body">
                    ...
                    >
                        ...
                        <td
                            ...
                            data-label="Код"
                        >
                            <span class="org-table__meta-item">
                                {{ item.code }}
                            </span>
                        </td>
