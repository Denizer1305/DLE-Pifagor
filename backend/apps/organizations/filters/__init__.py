from apps.organizations.filters.department_filters import filter_departments_queryset
...
from apps.organizations.filters.study_group_filters import filter_study_groups_queryset
from apps.organizations.filters.subject_filters import filter_subjects_queryset
