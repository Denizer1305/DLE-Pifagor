...
This section describes the main user scenarios of DLE "Pifagor".

## Sections

- [Administrator](admin-guide.en.md)
- [Teacher](teacher-guide.en.md)
- [Student](student-guide.en.md)
- [Parent](parent-guide.en.md)
